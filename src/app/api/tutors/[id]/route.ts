    ...
    try {
        ...
        if (!isOwner && !isAdmin) {
            ...
            return NextResponse.json({
                ...
                teachingLevelsOther: tutor.teachingLevelsOther || "",
                experienceLevel: tutor.experienceLevel || "Less than 1 year",
        ...
        // Fetch connections for the tutor
        const connections = await Connection.find({
            $or: [{ tutor: tutor.user?._id }, { tutor: tutor._id }]
        }).populate("student", "name");
        ...
        const tutorData = {
            ...
            teachingLevelsOther: tutor.teachingLevelsOther || "",
            experienceLevel: tutor.experienceLevel || "Less than 1 year",
            hasDegree: tutor.hasDegree || false,
            degreeName: tutor.degreeName || "",
            ...
            isPublicProfile: tutor.user?.isPublicProfile ?? true,
            connections,
