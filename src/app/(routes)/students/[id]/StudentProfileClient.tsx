...
import {
  BookOpen, GraduationCap, History, Award, Zap, Target, ShieldCheck, Trophy
} from "lucide-react";
...
export function StudentProfileClient({ studentData, userId }: StudentProfileClientProps) {
  const { user: clerkUser } = useUser();
  const isOwner = clerkUser?.publicMetadata?.databaseId === userId || studentData?.clerkId === clerkUser?.id;
