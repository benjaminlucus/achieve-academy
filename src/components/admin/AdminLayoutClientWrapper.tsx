...
import MobileAdminMenuTrigger from "./MobileAdminMenuTrigger";
import AdminChatInitializer from "../chat/AdminChatInitializer";
          ...
          <header className="mb-8 md:mb-14 flex flex-col md:flex-row md:items-center justify-between gap-6 pt-16 lg:pt-0">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-2 md:space-y-3">
                <h1 className="text-3xl md:text-4xl font-black text-dark-navy tracking-tight uppercase">
                  Admin Panel
                </h1>
