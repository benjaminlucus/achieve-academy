...
export default function Footer() {
  ...
  return (
    <footer className="bg-deep-black text-off-white py-20 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4">
              <Link href="https://facebook.com" target="_blank" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors text-gray-400 hover:text-off-white">
                <FaFacebook size={20} />
              </Link>
              <Link href="https://twitter.com" target="_blank" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors text-gray-400 hover:text-off-white">
                <FaTwitter size={20} />
              </Link>
              <Link href="https://instagram.com" target="_blank" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors text-gray-400 hover:text-off-white">
                <FaInstagram size={20} />
              </Link>
              <Link href="https://linkedin.com" target="_blank" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors text-gray-400 hover:text-off-white">
                <FaLinkedin size={20} />
              </Link>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-purple-secondary uppercase tracking-widest text-sm">Platform</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-purple-secondary uppercase tracking-widest text-sm">Support</h4>
            <ul className="flex flex-col gap-4 text-gray-400 font-medium">
          ...
          <div className="flex flex-col gap-6">
            <h4 className="text-lg font-bold text-purple-secondary uppercase tracking-widest text-sm">Contact</h4>
            <div className="flex flex-col gap-4 text-gray-400 font-medium">
              <div className="flex items-center gap-3">
                <Mail size={18} className="text-purple-secondary" />
                <span>contact@ravencrestacademy.com</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone size={18} className="text-purple-secondary" />
                <span>+92 3015040363</span>
              </div>
              <div className="flex items-center gap-3">
                <MapPin size={18} className="text-purple-secondary" />
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-4 text-gray-400 text-sm font-medium">
